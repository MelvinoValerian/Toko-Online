        ...
        <table class="table table-bordered">
            ...
            <tbody>
                <?php while ($row = mysqli_fetch_assoc($result_keranjang)) { 
                    ...
                    ?>
                <tr>
                    <td><img src="foto_produk/<?= $row['foto_produk'] ?>" alt="<?= $row['nama_produk'] ?>"
                    ...
                    <td>
                        <a href="hapus_keranjang.php?id=<?= $row['id_keranjang'] ?>" class="btn btn-danger btn-sm"
                            onclick="return confirm('Apakah Anda yakin ingin menghapus produk ini dari keranjang?')">Hapus</a>
                    </td>
                </tr>
                <?php } ?>
            </tbody>
